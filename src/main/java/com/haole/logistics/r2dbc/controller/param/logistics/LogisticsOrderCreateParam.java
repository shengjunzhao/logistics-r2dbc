...
public class LogisticsOrderCreateParam implements Serializable {
    @Serial
    ...
    private LogisticAddressCreateParam deliveryAddress;
    ...
    private LogisticAddressCreateParam receiveAddress;
...
//    @Size(min = 1, message = "至少需要有一个商品")
    private List<LogisticsGoodsCreateParam> goodsItems;
    ...
    private List<LogisticsWayInfoCreateParam> logisticsOrderWayInfoList;
    ...
    public LogisticAddressCreateParam getDeliveryAddress() {
        return deliveryAddress;
    }

    public void setDeliveryAddress(LogisticAddressCreateParam deliveryAddress) {
        this.deliveryAddress = deliveryAddress;
    }

    public LogisticAddressCreateParam getReceiveAddress() {
        return receiveAddress;
    }

    public void setReceiveAddress(LogisticAddressCreateParam receiveAddress) {
    ...
    public List<LogisticsGoodsCreateParam> getGoodsItems() {
        return goodsItems;
    }

    public void setGoodsItems(List<LogisticsGoodsCreateParam> goodsItems) {
        this.goodsItems = goodsItems;
    }

    public List<LogisticsWayInfoCreateParam> getLogisticsOrderWayInfoList() {
        return logisticsOrderWayInfoList;
    }

    public void setLogisticsOrderWayInfoList(List<LogisticsWayInfoCreateParam> logisticsOrderWayInfoList) {
